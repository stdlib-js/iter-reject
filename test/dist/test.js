...
tape( 'the function returns an iterator protocol-compliant object which rejects iterated values according to a predicate function', function test( t ) {
	...
	it = iterReject( array2iterator( values ), predicate );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which rejects iterated values according to a predicate function (all succeed)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function returns an iterator protocol-compliant object which rejects iterated values according to a predicate function (all fail)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'the function supports specifying the predicate function execution context', function test( t ) {
	...
	it = iterReject( array2iterator( values ), predicate, ctx );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'if an environment supports `Symbol.iterator` and the provided iterator is iterable, the returned iterator is iterable', function test( t ) {
	...
	iterReject = proxyquire( './../dist/main.js', {
